...
func TestEvaluationInput(t *testing.T) {
	var tests = []struct {
	...
	}{
		{
			...
			evaluationhttpadapter.NewEvaluation(1, 1, 1, evaluationservice.SINGLE, []int{1, 0, 1}, nil, nil),
			http.StatusOK,
			0,
		},
		{
			"married with house and vehicle",
			evaluationhttpadapter.NewEvaluation(1, 1, 1, evaluationservice.MARRIED, []int{1, 0, 1}, &evaluationhttpadapter.House{OwnershipStatus: evaluationservice.OWNED}, &evaluationhttpadapter.Vehicle{Year: 2015}),
			http.StatusOK,
			0,
		},
		{
			"no house ownership status",
			evaluationhttpadapter.NewEvaluation(1, 1, 1, evaluationservice.MARRIED, []int{1, 0, 1}, &evaluationhttpadapter.House{}, nil),
			http.StatusBadRequest,
			1,
		},
		{
			"no vehicle year",
			evaluationhttpadapter.NewEvaluation(1, 1, 1, evaluationservice.MARRIED, []int{1, 0, 1}, &evaluationhttpadapter.House{OwnershipStatus: evaluationservice.OWNED}, &evaluationhttpadapter.Vehicle{}),
			http.StatusBadRequest,
			1,
		},
		{
		...
		},
		{
			...
			evaluationhttpadapter.NewEvaluation(1, 1, 1, "unknown", []int{1, 0, 1}, &evaluationhttpadapter.House{OwnershipStatus: evaluationservice.OWNED}, &evaluationhttpadapter.Vehicle{Year: 2015}),
			http.StatusBadRequest,
			1,
		},
		{
			"invalid ownership status",
			evaluationhttpadapter.NewEvaluation(1, 1, 1, evaluationservice.MARRIED, []int{1, 0, 1}, &evaluationhttpadapter.House{OwnershipStatus: "unknown"}, &evaluationhttpadapter.Vehicle{Year: 2015}),
			http.StatusBadRequest,
			1,
		},
		{
			"incomplete risk questions",
			evaluationhttpadapter.NewEvaluation(1, 1, 1, evaluationservice.MARRIED, []int{1, 0}, &evaluationhttpadapter.House{OwnershipStatus: evaluationservice.OWNED}, &evaluationhttpadapter.Vehicle{Year: 2015}),
			http.StatusBadRequest,
			1,
		},
		{
